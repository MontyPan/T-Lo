...
public class Stack {
	 ...
	 * 	<li>若 stack.length > 10 且 index < stack.length / 3，將呼叫 changeLength()，使 stack 長度減半。</li>
	 *  <li>若 stack.length 更變後的最小長度至少為 10。
	 * </ol>
	 ...
	 * 讓 stack 長度減為一半後，仍保有目前 1/3 的 stack 長度可以 push 而不會立即呼叫 {@link #changeLength(int)}，<br><br>
